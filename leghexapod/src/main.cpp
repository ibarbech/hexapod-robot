...
/** \mainpage RoboComp::leghexapod
 *
 * \section intro_sec Introduction
 *
 * The leghexapod component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/leghexapod --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class leghexapod : public RoboComp::Application
{
public:
	leghexapod (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::leghexapod::run(int argc, char* argv[])
{
